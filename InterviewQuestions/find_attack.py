...
def detect_attack(requests):
    ...
    for request in requests:
        ...
        if request_count[key] > 3:
            ...
            if attacks and timestamp - attacks[0][0] >= timedelta(minutes=1):
...
requests_bank = [
    ...
    {"ip": "192.168.1.1", "port": 8080, "timestamp": "2024-03-20 12:00:10"},
    {"ip": "192.168.1.2", "port": 8080, "timestamp": "2024-03-20 12:00:15"},
    {"ip": "192.168.1.1", "port": 8080, "timestamp": "2024-03-20 12:00:20"},
    {"ip": "192.168.1.1", "port": 8080, "timestamp": "2024-03-20 12:00:25"},
    {"ip": "192.168.1.2", "port": 8080, "timestamp": "2024-03-20 12:00:20"},
